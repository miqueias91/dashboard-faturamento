<!-- Inicio Corpo do Boleto-->
<div class="container">
	<div class="">
  <div class="instructions">

		
		<div class="instr_content">
			...
			<h2>Linha Digitável: <?php echo $dadosboleto["linha_digitavel"]?></h2>
			<h2>Valor: <?php echo $dadosboleto["valor_boleto"]?></h2>

		</div>	<!-- class="instr_content" -->
	</div>	<!-- class="instructions" -->
	
	<div class="boleto">
		<div class="cut pontilhada1">
		...
		<tbody>
		<tr>
			<td width=150><IMG style="width:161px;height:32px" SRC="<?=$base_http?>/image/logo_banco/logosicoob.jpg"></td>
			<td width=50>
		...
		<tr class="titulos">
			<td class="sacado">
				<?php echo $dadosboleto['descricaohistorico'];?>
			</td>
		</tr>
		</tbody>
		</table>
		...
		<tr><td class="last_line" rowspan="6">
			...
			<tr class="campos">
				<td class="instrucoes" rowspan="5">
					...
					<br>
					<p><?php echo $dadosboleto['descricaohistorico'];?></p>
				</td>
			</tr>
			</tbody>
			</table>
		...
		<div class="barcode">
			<p><?php $sicoob->fbarcode($dadosboleto["codigo_barras"]); ?></p>
		</div>

		<div class="cut pontilhada3">
			<p>Corte na linha pontilhada</p>
		</div>
	</div>
</div>
<?php if($total_boletos > $i){ 
?>
	<div class="footer-boleto"></div>
<?php }
?>
<!-- Fim Corpo do Boleto-->
